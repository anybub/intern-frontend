      ...
      <div className="flex flex-col text-center gap-10 mt-5">
        <div>
          ...
          <p className="w-[80%] m-auto body-medium text-light-2">
            e-Election is a modern voting system that leverages blockchain
            technologies to ensure transparency, security, and immutability of
            the voting process. By utilizing blockchain, every vote is recorded
            on a decentralized and tamper-proof ledger, making it virtually
            impossible to manipulate or alter the results. This technology
            eliminates the need for intermediaries and provides a trustless
            environment for conducting elections. With e-Election, voters can
            have confidence in the integrity of the electoral process, and the
            results can be easily audited and verified by anyone. Join us in
            embracing the future of democracy with e-Election and blockchain
            technologies.
          </p>
        </div>
        <div>
