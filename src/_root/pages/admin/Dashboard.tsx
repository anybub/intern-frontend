...
const Dashboard = () => {
  ...
  return (
    <div className="w-full h-[100vh] flex flex-col gap-3 bg-dark-2 p-8">
      ...
      <div className="text-white flex justify-around gap-2 my-8 flex-wrap">
      ...
      {user && (user?.role === "Admin" || user?.role === "Super Admin") && (
        <Button
          className="bg-orange-500 text-white px-4 py-2 rounded-lg m-auto"
